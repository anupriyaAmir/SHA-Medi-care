...
$("#email_error_message2").hide();
  ...
  var clg_code=false;
	...
	function check_username() {
		...
		if(username_length < 1 || username_length > 20) {
...
//	var code = "mca@18";
  var clg = $("#clg_code").val();
	// if(clg != "Siddha" || clg != "Homeopathy" || clg != "Ayurvedic" ) {
	// 	$("#clg_codeerror").html("please insert correct field");
	// 	$("#clg_codeerror").show();
	// 	error_retype_password = true;
	// 	document.getElementById("doRegister").disabled = true;
	// } else {
...
function check_reg()
{
	...
	$("#doRegister").focusout(function() {
		...
		if(error_username2 == false && error_username == false && error_password == false && error_retype_password == false && error_email == false ) {
