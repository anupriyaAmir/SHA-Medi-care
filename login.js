...
$('#sr').on('click', function (e) {
  ...
  var usersRef = dbRef.ref('Doctor');
  var auth = null;
  var ref=dbRef.ref('User');
  //Register
  $('#doRegister').on('click', function (e) {
    ...
    var data = {
      FName:$('#registerFirstName').val(),
      LName:$('#registerLastName').val(),
      email: $('#registerEmail').val(), //get the email from Form
      Specialist:$('#clg_code').val(),
      isAdmin:true
      ...
      if( passwords.password == passwords.cPassword ){
        ...
        firebase.auth()
          ...
          .then(function(user){
            ...
            location.href=encodeURI("home.html");
          })
        ...
        firebase.auth()
          ...
          .then(function(user){
            ...
            ref.child(user.uid).set({
                FName:   $("#registerFirstName2").val().toUpperCase(),
                LName: $("#roll").val(),
                Age:$("#reg").val(),
